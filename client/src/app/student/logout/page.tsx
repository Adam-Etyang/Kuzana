  ...
  return (
    <main className="min-h-screen bg-[#F5F0E9] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 shadow-xl p-8">
        ...
        <div className="w-16 h-16 mx-auto rounded-full bg-[#112250]/10 flex items-center justify-center mb-6">
          <GraduationCap className="w-8 h-8 text-[#112250]" />
        </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          You'll need to sign in again to continue your mentorship journey.
        </p>
